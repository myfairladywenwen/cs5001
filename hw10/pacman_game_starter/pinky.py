...
class Pinky(GameCharacter):
    def __init__(self, maze, pacman, game_controller):
        ...
        self.y_add = 0
        self.eyes = Eyes()
        self.looking = (0, 0)  # the direction
    ...
    def update(self):
        ...
        if abs(up_down_part) >= abs(left_right_part):  # should go up or down
    ...
    def update_eyes(self, up_down_part, left_right_part):
        ...
        if left_right_part and abs(left_right_part) > 5:
            ...
            x = 0
        self.looking = (x, y)  # the direction is a tuple

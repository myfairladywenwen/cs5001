...
linear search and binary search"""
    ...
    @staticmethod
    # defined for the class, can be called directly,
    # no obj of this class, no self parameter;
    ...
    def binary_search(array, value):
        #array must be sorted so as to use binary search
        """Search _list for value using binary search"""
        left = 0
        right = len(array) - 1
        while(left <= right):
            mid = int((left+right)/2)  # floor value
            if (value == array[mid]):
